      ...
      <div className="bg-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[60vw] h-[80vh] shadow-xl">
        <div className="w-full h-full flex flex-col px-10 py-8">
          <div className="h-[60%] flex flex-col items-center space-y-[1.5rem]">
            ...
            <div>Major Project</div>
            <div>Submitted in 7th Semester of Bachelor of Technology</div>
            <div>{`SHRI RAM INSTITUTE OF TECHNOLOGY, JABALPUR (M.P.)`}</div>
            <div>In</div>
            <div>Computer Science & Engineering</div>
            <div>{`Session : 20023-24`}</div>
          </div>
          <div className="h-[40%] flex justify-around">
            <div className=" flex flex-col">
              <div className="text-blue-900 text-[16px] font-bold pb-[2rem] ">
                Submitted By
              </div>
